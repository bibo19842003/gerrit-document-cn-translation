...
[JavaScript Plugin Development](pg-plugin-dev.md) guide.
...
[post review](rest-api-changes.html) REST endpoint is invoked.
...
[plugin install](cmd-plugin-install.md) command.
...
* [JavaScript Plugin API](pg-plugin-dev.md)
